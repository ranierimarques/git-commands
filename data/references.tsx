    ...
    commands: [
      {
        ...
        code: [['git'], ['init', 'Comando para iniciar o repositório git']],
      },
      {
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        code: [['git'], ['status', 'Comando que mostra o ambiente de staging']],
      },
      {
        ...
        examples: [
          {
            ...
            code: [
              ['git'],
              ['diff', 'Lista de forma interativa as alterações de cada arquivo'],
              ['--name-only', 'Flag para mostrar apenas o nome dos arquivos modificados'],
            ],
          },
        ],
      },
    ...
    commands: [
      {
        ...
        code: [['git'], ['branch', 'Comando para listar as branches']],
        examples: [
          {
      ...
      },
      {
        ...
        code: [['git'], ['stash', 'Comando para gerenciar stashes']],
        examples: [
          {
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        code: [['git'], ['remote', 'Comando para gerenciar remotes']],
        examples: [
          {
